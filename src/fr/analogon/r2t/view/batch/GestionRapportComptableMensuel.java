...
public class GestionRapportComptableMensuel extends fr.analogon.r2t.main.RacineServlet 
{
	
	private String numeroMois="";
	...
	{		
		debug.logger.debug("Batch raport comptable mensuelle............. ");
		...
		if(choix.equalsIgnoreCase("lancer"))
		{
			...
			debug.logger.debug("lancement raport comptable mensuel du mois ="+numeroMois);
			...
			response.sendRedirect("./entree?action=gestionBatchRapportsComptableMensuel.jsp&numeroBatch="+numeroBatch);
	...
	{		
		...
		if ((request.getParameter("numeroMois") != null)) 
			this.numeroMois = request.getParameter("numeroMois");
