...
public class BaffResultatExport extends fr.analogon.r2t.main.RacineBean {
	...
	{	
		...
		sqlExport="select DISTINCT r.numRedevable,r.nomredevable,r.prenom,r.naturejuridique,r.civilite,r.nomjf,r.actif,"+
		...
		String sqlRecherche="select DISTINCT r.numRedevable,r.nomredevable,r.prenom,r.numrue,r.adresse1,"+
							"e.numero,e.enactivite,e.numrue,e.adresse1,e.adresse2,e.adresse3,i.libelle,f.numeroFacture ";
		...
		from+="join facture f on f.idclient=r.numRedevable ";
		...
		//Query pour rapport excel
		sqlExport+=from+where+orderBy;
		...
		try {
			...
			try{			
				...
				if(count==0){
					...
					linkExport="<a href='javascript:exporter()'><font face='Arial' size='4'><b>Exporter : </b></font><img border='0' src='images/ok.gif' align='absmiddle'></a>";
					//linkExport="<a href='exportExcel?sql="+URLEncoder.encode(sqlExport,"UTF-8")  +"'><font face='Arial' size='4'><b>Exporter : </b></font><img border='0' src='images/ok.gif' align='absmiddle'></a>";
