...
<head>
  <%@ page language = "java" %>
  <jsp:useBean id="baffBatch" scope="page" class="fr.analogon.r2t.view.batch.BaffSuivieDeFacturation" />
  ...
  <table bordercolordark="#ffffff" bordercolorlight="#c0c0c0" border="1" cellpadding="0" cellspacing="0" height="17" width="1117">
   ...
   <A NAME="informationBatch">   
      ...
      <td width="1113" bgcolor="#AFF3BB" height="22"><b><font size="4"><span style="text-transform: uppercase">Information</span></font></b><span style="text-transform: uppercase"><b><font size="4">
        BATCH SUIVI DE FACTURATION:</font></b></span></td>
      </a>    </tr>
...
<table bordercolordark="#ffffff" bordercolorlight="#c0c0c0" border="1" cellpadding="0" cellspacing="0" height="114" width="1117">
  ...
  <tr>
    <td bgcolor="#AFF3BB" height="22"><b><font size="4"><span style="text-transform: uppercase"> rOle
      </span></font></b>
   ...
   <A NAME="informationBatch">   
      ...
      <span style="text-transform: uppercase"><b><font size="4">
        SUIVI DE FACTURATION</font></b></span>
      </a>    <b><font size="4"><span style="text-transform: uppercase"> </span></font></b><span style="text-transform: uppercase"><b><font size="4">:</font></b></span></td>
  </tr>
  <tr>
    <td height="22" align="center"><a target='_blank' href="<jsp:getProperty name="baffBatch" property="lienFichierSuivieFacturation"/>"> Role
      Suivi de facturation</a> </td>
  </tr>
  <tr>
