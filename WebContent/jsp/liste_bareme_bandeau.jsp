  ...
  <table border="0" cellpadding="0" cellspacing="0" width="98%">
    <tr>
      <td background="../images/fond_trait.gif" width="15%">
        <p align="center"><img border="0" src="../images/parametres_rond.gif" width="60" height="40"></p>
      </td>
    <td background="../images/fond_trait.gif" valign="top">
      <p align="right"><font face="Arial" size="5">BAREMES</font></td>
  </tr>
  </table>
</div>
    ...
    <table border="1" cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF" height="31">
      <tr>
        ...
        <td width="31%" bgcolor="#DFFFEF" height="29">
          ...
          <a target="bas" href="../entree?action=empl_recherche_bareme.jsp"">
          <img border="0" src="../images/ok.gif" align="absmiddle" width="25" height="25"></a>&nbsp;
        </td>
        <td bgcolor="#DFFFEF" width="29%" height="29">
          <p style="margin-left: 5" align="center">
          <font face="Arial" size="2"><b>Création : </b></font>
          <a target="bas" href="../entree?action=empl_gestion_bareme.jsp&choix=ajouter">
          <img border="0" src="../images/ok.gif" align="absmiddle" width="25" height="25"></a>
        </td>
...
<script language="javascript" type="text/javascript">
   window.open("../entree?action=empl_recherche_bareme.jsp","bas");
</script>
<% } %> 
</body>
</html>
