...
<form method="POST" action="entree?action=liste_communiqe.jsp">
...
<input type="hidden" name="choix" size="20" value="chercher" >
  ...
  <div align="center">
    <div align="center">
        <center>
      <table border="1" cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF" height="86">
        <tr>
        ...
        <tr>
		  ...
		  <td height="12">&nbsp;</td>
	  	  ...
	  	  <tr>
			  <td height="12"><b> <font face="Arial" size="2">&nbsp;Secteur  :</font></b></td>
			  <td height="12"> <jsp:getProperty name="beanDivers" property="listeSecteur" />
			  </td>
			  <td height="12">&nbsp;</td>
		  </tr>
