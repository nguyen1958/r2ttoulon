...
<head>
  <%@ page language = "java" %>
  <jsp:useBean id="baffBatch" scope="page" class="fr.analogon.r2t.view.batch.BaffBatchRapportComptableMarche" />
...
<tr>
    <td width="489" height="22" align="center">
    	<jsp:getProperty name="baffBatch" property="lienRapportEncaissementJour"/>
    </td>
    <td width="622" height="22" align="center">
    	<jsp:getProperty name="baffBatch" property="lienRapportSuiviPresenceRedevable"/>
    </td>
</tr>

<tr>
    <td width="489" height="22" align="center">
    	<jsp:getProperty name="baffBatch" property="lienRapportRecapMensuelParFamilleMarche"/>
    </td>
    <td width="622" height="22" align="center">
    	<jsp:getProperty name="baffBatch" property="lienRapportRecapMoisParJour"/>
    </td>
</tr>

<tr>
    <td width="1111" height="22" align="center" colspan="2">
    	<jsp:getProperty name="baffBatch" property="lienRapportRecuAbonne"/>
    </td>
</tr>
