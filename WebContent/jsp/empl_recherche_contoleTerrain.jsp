...
<form method="POST" action="entree?action=liste_contoleTerrain.jsp&type='recherche'">
...
<input type="hidden" name="choix" size="20" value="chercher" >
  ...
  <div align="center">
    <div align="center">
        <center>
      <table border="1" cellpadding="0" cellspacing="0" width="1146" bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF" height="50">
        <tr>
      ...
      <td width="252" height="22">
       ...
       <tr>
      <td width="231" height="22"><b><font face="Arial" size="2">&nbsp;Contrôleur
        :</font></b>      </td>
      <td width="252" height="22">
