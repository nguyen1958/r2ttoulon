...
<input type="text" size="51" maxlength="40" name="nomCommercialEmplacment"
...
<input type="text" size="45" readonly name="NomQuartier" value="<jsp:getProperty name="beanEmplGeneral" property="nomQuartier"/>" >
</td>
</tr>
...
<input type="text" size="29" maxlength="40" name="adresse2"
...
value=<jsp:getProperty name="beanEmplGeneral" property="codePostal" />></b>&nbsp;&nbsp;</font></p>
</td>
</tr>
...
<p style="margin-left: 2">
<font size="2" face="Arial">compl. Adresse :<b>&nbsp;&nbsp; <input type="text" size="29" maxlength="40" name="adresse3"
...
<input type="checkbox" onClick="modifierCedex()" name="cedexCk" <jsp:getProperty name="beanEmplGeneral" property="cedex"/>>Cédex</font></p>
...
></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Date d'inscription: <input type="text" size="17" maxlength="10" name="dateInscription" id="dateInscription"
...
<input type="text" size="21" maxlength="10" name="dateDebutActivite" id="dateDebutActivite"
...
<input type="text" size="17" maxlength="10" name="dateFinActivite" id="dateFinActivite"
...
<td width="906" colspan="2" height="26">
<input type="text" size="21" maxlength="10" name="dateReceptionDeclaration" id="dateReceptionDeclaration"
...
<td width="906" colspan="2" height="23">
<font size="2" face="Arial"><input type="text" size="29" maxlength="40" name="taxiImmatriculation"
...
<tr>
<td width="269" background="./images/fond_bleu.gif" height="23">
<font size="2" face="Arial"><b>&nbsp;Companie autobus :</b></font>
</td>
<td width="906" colspan="2" height="23">
<font size="2" face="Arial"><input type="text" size="29" maxlength="40" name="busCompanieAutobus"
...
<td width="906" colspan="2" height="23">
<font size="2" face="Arial"><input type="text" size="29" maxlength="40" name="busLigneDeBus"
...
<td width="906" colspan="2" height="23">
<font size="2" face="Arial"><input type="text" size="29" maxlength="40" name="marcheNomMarche"
...
<td width="906" colspan="2" height="23">
<font size="2" face="Arial"><input type="text" size="29" maxlength="40" name="ambulantNomTournee"
...
:</b></font>
<input type="text" size="22" maxlength="40" name="ambulantVehiculeMarque"
value="<%=beanEmplGeneral.getAmbulantVehiculeMarque()%>" >
</td>
<td width="33%">&nbsp;<font size="2" face="Arial"><b>Modele
:</b></font>
<input type="text" size="22" maxlength="40" name="ambulantVehiculeModele"
value="<%=beanEmplGeneral.getAmbulantVehiculeModele()%>" >
</td>
<td width="34%">&nbsp;<font size="2" face="Arial"><b>Immatriculation
:</b></font>
<input type="text" size="22" maxlength="40" name="ambulantVehiculeImmatriculation"
...
<tr>
<td width="269" background="./images/fond_bleu.gif" height="23">
<font size="2" face="Arial"><b>&nbsp;Companie assurance :</b></font>
</td>
<td width="906" colspan="2" height="23">
<font size="2" face="Arial"><input type="text" size="29" maxlength="40" name="ambulantCompanieAssurance"
...
<td width="906" colspan="2" height="23">
<font size="2" face="Arial"><input type="text" size="40" maxlength="40" name="conventionObjet"
...
<td width="906" colspan="2" height="23">
<font size="2" face="Arial"><input type="text" size="40" maxlength="40" name="conventionLibelle"
...
:</b></font><font size="2" face="Arial"><input type="text" size="19" maxlength="40"
...
value="<%=beanEmplGeneral.getDroitDeVoirieNomInspecteur()%>" >
</font>
</td>
</tr>
<tr>
...
<td width="906" colspan="2" height="23">
<font size="2" face="Arial"><input type="text" size="40" maxlength="40" name="droitDeVoirieNature"
...
<td width="906" colspan="2" height="23">
<font size="2" face="Arial"><input type="text" size="40" maxlength="40" name="droitDeVoirieObjetDeTraveaux"
...
<td width="906" colspan="2" height="23">
<font size="2" face="Arial"><input type="text" size="40" maxlength="40" name="droitDeVoirieObjetDeAutorisation"
...
<td width="906" colspan="2" height="23">
<font size="2" face="Arial"><input type="text" size="29" maxlength="40" name="kiosqueCategorie"
...
<td width="906" colspan="2" height="23">
<font size="2" face="Arial"><input type="text" size="29" maxlength="40" name="kiosqueNatureVente"
...
<td width="906" colspan="2" height="23">
<font size="2" face="Arial"><input type="text" size="29" maxlength="40" name="nomProprietaire"
...
<td width="78%"><input type="text" name="nomRedevable" size="33"/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
