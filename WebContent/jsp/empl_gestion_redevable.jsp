   ...
   function modifier()
   {
    ...
    if(document.forms[0].redevableActif.value == "NON" )
    {
     ...
     if( verfiEmailLiquidateur==0 && verfiMailRedevable==0 && 
          ...
          && verifCodePostaleRedevable==0 &&  verifVilleeRedevable==0 
...
<table border="1" cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF" height="241">
         ...
         <table border="1" width="100%">
          <tr>
            ...
            <td width="65%"><b><font size="2" face="Arial">Nom </font><font color="#FF0000" face="Arial" size="4">*</font><font size="2" face="Arial"> :
              ...
              <input  type="text" name="nomRedevable"  id="nomRedevable"  size="40"  value="<jsp:getProperty name="beanRole" property="nomRedevable"/>"  >
      ...
      <tr>
        ...
        <td width="80%" colspan="2" height="23">
          <table border="1" width="100%">
            <tr>
              <td width="35%"><input  type="text"   name="responsableRedevable" id="responsableRedevable" 
   value="<jsp:getProperty name="beanRole" property="responsableRedevable"/>"
                maxlength=&quot;40&quot; size="40" >&nbsp;</td>
              <td width="65%"><b>
           Nom de jeune fille :</b>
           <input  type="text" name="nomJeuneFilleRedevable" id="nomJeuneFilleRedevable" 
        ...
        <td width="80%" colspan="2" height="23">
          <table border="1" width="100%">
            <tr>
              ...
              <td width="35%"><input  onchange="verfierUnicite()" onclick="verfierUnicite()"  type="text" name="siren" id="siren" 
		   
             value="<jsp:getProperty name="beanRole" property="siren"/>"
                maxlength="9"; size="9"></td>
				<td width="65%"><b><font size="2" face="Arial">Siret : </font></b>
				<input  type="text" onchange="verfierUnicite()" onclick="verfierUnicite()"      name="siret" id="siret" 
   ...
   value="<jsp:getProperty name="beanRole" property="siret"/>"
     ...
     <tr>
        ...
        <td width="80%" colspan="2" height="24">
		  ...
		  src="./images/calendar.gif" border="0" width="20" height="18" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
              <td width="65%"><b>
          Lieu de naissance :&nbsp;</b><input  type="text" 
     ...
     <tr>
        ...
        <td width="80%" colspan="2" height="64">
          <table border="1" width="100%" height="1">
            <tr>
              ...
              <b>Code Rivoli</b> <input  size="9" type="text" name="codeRivolieRedevable" id="codeRivolieRedevable" onChange="detecterChangementAdresse();"
                 value="<jsp:getProperty name="beanRole" property="codeRivolieRedevable"  />">
              <b>&nbsp;</b>
              <a href="javascript:rechercheVoieParCodeVoie(document.forms[0].codeRivolieRedevable.value,document.forms[0].numVoieRedevable.value);" >
      ...
      <tr>
        ...
        <font size="2" face="Arial"> :&nbsp;&nbsp;
          <input  type="text" name="villeeRedevable" id="villeeRedevable" onChange="detecterChangementAdresse();"
...
<table border="1" cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF" height="244">
        ...
        <td width="81%" colspan="2" height="22">
          <font size="2" face="Arial"><b><input type="text" size="29" maxlength="20" name="nomLiquidateur"
        ...
        <tr>        
           ...
           <td width="81%" colspan="2" height="23">
             <font size="2" face="Arial"><b><input type="text" size="29" maxlength="20"
        ...
        <p style="margin-left: 2">
          ...
          <input  type="text" name="villeeLiquidateur" id="villeeLiquidateur" 
        ...
        <tr>
          <td width="100%" bgcolor="#AFF3BB" height="1">
            <p style="margin-left: 5">
              ...
              <b><a href="javascript:modifier();">Valider</a></b>
          </td>
        </tr>
      </table> 
