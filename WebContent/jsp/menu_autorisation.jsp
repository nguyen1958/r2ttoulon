...
<body background="../images/back_parametres.gif" topmargin="0" leftmargin="0" link="#000000" alink="#000000" vlink="#000000">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="150">
    <tr>
      <td width="100%">
        <p><img border="0" src="../images/autorisation_dossier.gif" width="135" height="95">
        </p>
      </td>
    </tr>
    <tr>
      ...
      <a href="../entree?action=empl_recherche_autorisation.jsp" target="bas">
...
if (  typeTaxeAutorise.length() != 0 )           
{
 %>
    ...
    <tr>
      <td width="100%">
      <img border="0" src="../images/masque_menu.gif" align="absmiddle" width="21" height="20">
      <a target="bas" href="../entree?action=empl_gestion_autorisation.jsp&choix=creer">
