...
<%}%> 
    ...
    <tr>
	  <td align="left" width="294" height="1" nowrap>
          <b>
          <font color="#000000" size="2" face="Arial">&nbsp;Date de mise en application&nbsp;(</font></b><font color="#FF0000" size="2" face="Arial">JJ/MM/AAAA</font><b><font color="#000000" size="2" face="Arial">)</font><font face="Arial" color="#FF0000" size="3">*</font><font color="#000000" size="2" face="Arial">:</font>

          </b>

       <td width="210" align="left" height="1" nowrap>
      <input  type="text" name="dateDebutAutorisation" id="dateDebutAutorisation" size="15" maxlength="10" value="">
    ...
    <tr>
        <td align="left" width="294" height="2" nowrap>
          <b>
          <font color="#000000" size="2" face="Arial">&nbsp;Date de fin de
          validité&nbsp;(</font></b><font color="#FF0000" size="2" face="Arial">JJ/MM/AAAA</font><b><font color="#000000" size="2" face="Arial">)&nbsp;:</font>

          </b>

        </td>
	   <td align="left" width="210" height="2" nowrap>
          <input  type="text" name="dateFinAutorisation" id="dateFinAutorisation" size="15" maxlength="10" value="">
