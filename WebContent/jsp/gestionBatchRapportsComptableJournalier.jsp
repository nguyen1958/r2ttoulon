...
<head>
  <%@ page language = "java" %>
  <jsp:useBean id="baffBatch" scope="page" class="fr.analogon.r2t.view.batch.BaffBatchRapportComptableJournalier" />
...
<tr>
    <td width="489" height="22" align="center">
    	<jsp:getProperty name="baffBatch" property="lienRapportRecapitulatifComptesJournalierToulon"/>
    </td>
    <td width="622" height="22" align="center">
    	<jsp:getProperty name="baffBatch" property="lienRapportVersementJournalierToulon"/>
    </td>
</tr>

<tr>
    <td width="489" height="22" align="center">
    	<jsp:getProperty name="baffBatch" property="lienRapportVersementChequesJournalierToulon"/>
    </td>
    <td width="622" height="22" align="center">
    	<jsp:getProperty name="baffBatch" property="lienRapportListeQuittancesJournalierToulon"/>
    </td>
</tr>
...
<tr>
    <td width="489" height="22" align="center">
    	<jsp:getProperty name="baffBatch" property="lienRapportVersementCarteBancaireJournalierToulon"/>
    </td>
    <td width="622" height="22" align="center">
    	<jsp:getProperty name="baffBatch" property="lienRapportVersementChequesJournalierCompteRegieToulon"/>
    </td>
</tr>
