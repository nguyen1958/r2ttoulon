...
<form method="POST" action="entree?action=liste_marche.jsp">
  ...
  <div align="center">
    <div align="center">
      ...
      <td width="238" height="23">        
        <b><font face="Arial" size="2">&nbsp;Code marché :</font></b>
      </td>
          <td width="173" height="23">
            <input type="text" name="codeMarche" size="20" >
          </td>
        ...
        <tr>
      <td width="238" height="23">
        <b><font face="Arial" size="2">&nbsp;Libellé marché :</font></b>
      </td>
          <td width="173" height="23">
            <input type="text" name="libelleMarche" size="20" >
          </td>
          <td width="808" height="23">
            &nbsp;&nbsp;</td>
        </tr>
