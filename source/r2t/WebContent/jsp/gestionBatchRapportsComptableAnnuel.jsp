...
<head>
  <%@ page language = "java" %>
  <jsp:useBean id="baffBatch" scope="page" class="fr.analogon.r2t.view.batch.BaffBatchRapportComptableAnuelle" />
...
<tr>
    <td width="489" height="22" align="center">    	
		<jsp:getProperty name="baffBatch" property="lienListeDesAnnulationsAnnuelToulon"/>
    </td>
    <td width="622" height="22" align="center">
    	<jsp:getProperty name="baffBatch" property="lienListeDesAcomptesAnnuelToulon"/>
    </td>
</tr>
<tr>
    <td width="489" height="22" align="center">
    	
		<jsp:getProperty name="baffBatch" property="lienListeDesImpayesAnnuelTLPEToulon"/>
    </td>
    <td width="622" height="22" align="center">
    	<jsp:getProperty name="baffBatch" property="lienListeDesImpayesAnnuelEtalageToulon"/>
    </td>
</tr>
<tr>
    <td width="489" height="22" align="center">	
		<jsp:getProperty name="baffBatch" property="lienVentilationParBaremeAnnuelTLPEToulon"/>
    </td>
    <td width="622" height="22" align="center">
    	<jsp:getProperty name="baffBatch" property="lienVentilationParBaremeAnnuelEtalageToulon"/>
    </td>
</tr>
<tr>
    <td width="489" height="22" align="center">
    	
		<jsp:getProperty name="baffBatch" property="lienVentilationParEmplacementAnnuelTLPEToulon"/>
    </td>
    <td width="622" height="22" align="center">
    	<jsp:getProperty name="baffBatch" property="lienVentilationParEmplacementAnnuelEtalageToulon"/>
    </td>
</tr>

<tr>
    <td width="1111" height="22" align="center" colspan="2">
    	<jsp:getProperty name="baffBatch" property="lienBalanceAnnuelToulon"/>
    </td>
</tr>
</table>
<% }%> 
