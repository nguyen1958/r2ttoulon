...
<div align="center">
  <table border="0" cellpadding="0" cellspacing="0" width="98%">
    ...
    <td background="../images/fond_trait.gif" valign="top">
      <p align="right"><font face="Arial" size="5">RECLAMATIONS</font></td>
  </tr>
  </table>
</div>
    ...
    <table border="1" cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF" height="31">
      <tr>
        ...
        <td width="31%" bgcolor="#DFFFEF" height="29">
          ...
          <a target="bas" href="../entree?action=empl_recherche_reclamations.jsp"">
        ...
        <td bgcolor="#DFFFEF" width="29%" height="29">
          ...
          <a target="bas" href="../entree?action=empl_gestion_reclamations.jsp&choix=ajouter">
...
window.open("../entree?action=empl_recherche_reclamations.jsp","bas");
</script>
<% } %> 
