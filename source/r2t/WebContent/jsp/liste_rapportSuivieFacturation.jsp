...
<jsp:useBean id="bean" scope="page" class="fr.analogon.r2t.view.batch.BAffListeRapportSuivieFacturation" />
<%bean.setRequest(request);%>

<title>LISTE DES BATCHS DE SUIVIE DE FACTURATION :</title>
...
<form method="POST" >
  ...
  <tr>
          <td width="100%" bgcolor="#AFF3BB">
            <p>
              <b><font size="4">LISTE DES BATCHS DE SUIVI DE FACTURATION :</font></b>          </td>
  </tr>

  <tr>
        <td width="1139" align="center" height="1">        
		
         <jsp:getProperty name="bean" property="listeRapportSuivieFacturation"/>
          </p>
        </td>
  </tr>
