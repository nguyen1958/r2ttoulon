...
<form method="POST" action="entree?action=liste_ville.jsp">
  ...
  <div align="center">
    <div align="center">
      ...
      <table border="1" cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF" height="125">
        ...
        <tr>
          <td colspan="3" bgcolor="#AFF3BB" width="1142" height="22">
            <b><font size="4">RECHERCHE VILLE :</font></b>
          </td>
        </tr>
      ...
      <td width="138" height="23">        
        <b><font face="Arial" size="2">&nbsp;Code :</font></b>
      </td>
        ...
        <tr>
      <td width="138" height="23">
        <b><font face="Arial" size="2">&nbsp;Ville :</font></b>
      </td>
          <td width="173" height="23">
